...
/**
 * Test achievementController.
 *
 * @author Sijin WANG
 * @since 20 November 2020
 */
public class achievementControllerTest extends ApplicationTest {
    ...
    public void start(Stage stage) throws IOException {
        Parent mainNode = FXMLLoader.load(Main.class.getClassLoader().getResource("fxml/achievementInfo.fxml"));
