...
/**
 * Control the page which introduces achievements in showInfo.
 *
 * <p>This class loads a page on the primary stage.
 * Images and texts about achievements will be shown in this page.</p>
 *
 * @author Sijin WANG
...
public class achievementInfoController {
     ...
     * which shows the functionality of setting.
     *
     * @param event mouse click
     * @throws IOException loader may not exist
     */
